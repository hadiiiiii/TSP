...
var ChannelID = "517286910352162817";//

var ChannelIID = "517286951729233947";
...
client.on('ready', () => {
  client.channels.find(ch => ch.id === "517286999678255144" && ch.type === 'voice').join();//اكتب اي دي روم صوت هنا
});//By Rie
